...
- Need firmware? Refer to the [Flashcard Archive](https://archive.flashcarts.net). Here you can compare the website listed on your flashcart to find the correct kernel for you. Feel free to ask for help in the [DS(i) Mode Hacking](https://discord.gg/yD3spjv) Discord server (English only) if you have trouble identifying your cart! You can also make a post in the [r/flashcarts](https://reddit.com/r/flashcarts) subreddit if you prefer.
