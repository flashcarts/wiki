...
1. Need firmware? Refer to the [DS-Homebrew Flashcard Archive](https://flashcard-archive.ds-homebrew.com). Here you can compare the website listed on your flashcart to find the correct kernel for you. Feel free to ask in the [DS(i) Mode Hacking](https://discord.gg/yD3spjv) Discord server (English only) if you have trouble identifying your cart!
